...
class RecentlyPlayedMenuItemView: NSView {
    ...
    private func setupConstraints() {
        ...
        imageLeadingConstraint = imageView.leadingAnchor.constraint(equalTo: leadingAnchor, constant: contentInsets.left)
        imageCenterYConstraint = imageView.centerYAnchor.constraint(equalTo: centerYAnchor)

        titleLeadingWithImage = titleLabel.leadingAnchor.constraint(equalTo: imageView.trailingAnchor, constant: 8)
        titleLeadingWithoutImage = titleLabel.leadingAnchor.constraint(equalTo: leadingAnchor, constant: contentInsets.left)
        ...
        NSLayoutConstraint.activate([
            ...
            subtitleLabel.bottomAnchor.constraint(lessThanOrEqualTo: bottomAnchor, constant: -contentInsets.bottom)
        ])
    }
