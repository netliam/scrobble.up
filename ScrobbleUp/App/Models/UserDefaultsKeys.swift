...
enum Keys {
    static let playerSwitching = UserDefaultsKey("playerSwitching", defaultValue: PlayerSwitching.automatic)
    static let playerOverride = UserDefaultsKey("playerOverride", defaultValue: PlayerOverride.none)
    static let openLinksWith = UserDefaultsKey("openLinksWith", defaultValue: OpenLinksWith.currentActivePlayerOrAppleMusic)
    ...
    static let listenBrainzBaseURL = UserDefaultsKey("listenBrainzBaseURL", defaultValue: "https://api.listenbrainz.org")
