      ...
      settingsWindowController = SettingsWindowController(
        panes: [
          Settings.Pane(
            ...
            title: NSLocalizedString("General", tableName: "GeneralSettings", comment: ""),
          ...
          Settings.Pane(
            ...
            title: "Notifications",
            toolbarIcon: NSImage(
              systemSymbolName: "bell.badge.fill", accessibilityDescription: "Notifications")!
          ) {
          ...
          Settings.Pane(
            ...
            title: "Hotkeys",
            toolbarIcon: NSImage(systemSymbolName: "keyboard", accessibilityDescription: "Hotkeys")!
          ) {
            HotkeysSettingsPane()
          },
          Settings.Pane(
