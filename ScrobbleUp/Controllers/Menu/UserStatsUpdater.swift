...
final class UserStatsUpdater {
	...
	func updateUserStats(
		...
		case .lastFm:
			updateLastFmStats(
				profileItem: profileItem, scrobblesRow: scrobblesRow, artistsRow: artistsRow!,
				lovedTracksRow: lovedTracksRow)
		case .listenBrainz:
			updateListenBrainzStats(
				profileItem: profileItem, scrobblesRow: scrobblesRow, lovedTracksRow: lovedTracksRow
			)
		}
	}
